...
parser.add_argument('--dataroot', help='path to dataset',default="D:\\WikiArt\\wik\\") # D:\\WikiArt\\wikiart\\ #/mydata
...
parser.add_argument('--disc_iterations', type=int, default=1,help="ratio of discriminator updates to generator")
...
parser.add_argument('--out_folder', default=None, help='folder to output images and model checkpoints') #"/output"
