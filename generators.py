...
class DcganGenerator(nn.Module):
    ...
    def __init__(self, z_noise, image_size, channels, num_gen_filters, pow=4):
        ...
        # self.main.add_module('initial_conv_transpose.{0}-{1}'.format(z_noise, current_gen_filters), nn.Conv2d(z_noise, current_gen_filters, kernel_size=4, stride=1, padding=0, bias=False))
